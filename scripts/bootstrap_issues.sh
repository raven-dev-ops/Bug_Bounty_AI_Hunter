...
REPO="${GITHUB_REPO:-raven-dev-ops/Bug_Bounty_AI_Hunter}"

if ! command -v gh >/dev/null 2>&1; then
  echo "Error: GitHub CLI (gh) is required to bootstrap labels/issues." >&2
  exit 1
fi
...
labels=(
  ...
  "type:research|1d76db|Research"
  "type:docs|0075ca|Documentation"
  "type:test|5319e7|Test"
  ...
  "risk:legal|b60205|Legal risk"
  "risk:tos|b60205|ToS risk"
  "risk:data-privacy|b60205|Data privacy risk"
  "risk:rate-limit|b60205|Rate limit risk"
)
...
issue_create \
  ...
  --label "type:chore,prio:P1,area:docs,status/triage" \
...
issue_create \
  ...
  --label "type:security,prio:P0,area:core,status/triage,tag/bug-bounty" \
...
issue_create \
  ...
  --label "type:feature,prio:P1,area:knowledge,status/triage,tag/ai-security" \
...
issue_create \
  ...
  --label "type:docs,prio:P2,area:knowledge,status/triage,tag/rag,tag/embeddings,tag/logging" \
...
issue_create \
  ...
  --label "type:feature,prio:P1,area:discovery,status/triage" \
...
issue_create \
  ...
  --label "type:feature,prio:P1,area:rag,status/triage,tag/rag,tag/ai-security" \
...
issue_create \
  ...
  --label "type:feature,prio:P1,area:embeddings,status/triage,tag/embeddings,tag/ai-security" \
...
issue_create \
  ...
  --label "type:feature,prio:P1,area:logging,status/triage,tag/logging" \
...
issue_create \
  ...
  --label "type:feature,prio:P1,area:reporting,status/triage,tag/bug-bounty" \
...
issue_create \
  ...
  --label "type:feature,prio:P2,area:reporting,status/triage" \
...
issue_create \
  ...
  --label "type:feature,prio:P2,area:labs,status/triage" \
...
issue_create \
  ...
  --label "type:chore,prio:P2,area:ci,status/triage" \
